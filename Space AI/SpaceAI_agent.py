...
class JarvisAgent:
    ...
    def system_prompt(self) -> str:
        base = (
            "Tu es Space AI, assistant IA personnel cree par l'utilisateur.\n"
    ...
    def generate_response(self, user_message: str) -> str:
        ...
        try:
            ...
            logging.error("Gemini call error: %s", exc)
            return f"Désolé, une erreur s'est produite lors de l'appel à Gemini : {exc}"
